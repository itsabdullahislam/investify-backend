...
], Investment.prototype, "investment_id", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => investor_entity_1.Investor, (investor) => investor.investments),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => campaign_entity_1.Campaign, (campaign) => campaign.investments),
    (0, typeorm_1.JoinColumn)({ name: 'campaign_id' }),
    __metadata("design:type", campaign_entity_1.Campaign)
], Investment.prototype, "campaign", void 0);
__decorate([
